...
<header className="text-gray-600 body-font shadow-lg">
    <div className="container mx-auto flex flex-wrap p-1 flex-col md:flex-row ">
     ...
     <div className="">
     <button className="inline-flex items-center text-white bg-indigo-500 border-0 py-1 px-4 focus:outline-none hover:bg-gray-200 hover:text-black
        rounded text-base mt-1 md:mt-0 float-right">Go To Cart
